...
config :fuse, Fuse.Repo,
  database: Path.expand("../fuse_dev.db", __DIR__),
  pool_size: 5,
  stacktrace: true,
...
config :fuse, FuseWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "ZXxa6DJgSLgO8EG+N1eFTgd2CKxEMCkvoZwQlRNoNWgPVsN7s5eLWtBGF4yedf5N",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:fuse, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:fuse, ~w(--watch)]}
  ]
...
config :fuse, FuseWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/fuse_web/(?:controllers|live|components|router)/?.*\.(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :fuse, dev_routes: true
