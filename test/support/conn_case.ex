defmodule FuseWeb.ConnCase do
  ...
  by setting `use FuseWeb.ConnCase, async: true`, although
  ...
  using do
    quote do
      ...
      @endpoint FuseWeb.Endpoint

      use FuseWeb, :verified_routes

      # Import conveniences for testing with connections
      import Plug.Conn
      import Phoenix.ConnTest
      import FuseWeb.ConnCase
    end
  end
